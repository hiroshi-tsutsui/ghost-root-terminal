...
for dist in distances:
    for persist in persistences:
        ...
        # Output to separate TP folder
        job['taskGroups'][0]['taskSpec']['volumes'][3]['gcs']['remotePath'] = f"yolo-gcp/eagle/infer/output/sweep_v4_1_tp/{job_name}/"
...
with open("submit_sweep_v4_1_tp.sh", "w") as f:
    f.write("#!/bin/bash\n")
