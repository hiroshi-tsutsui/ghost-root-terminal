...
const WebTerminal = () => {
  ...
  useEffect(() => {
    ...
    const handleCommand = async () => {
        ...
        if (commandLine) {
          const result = processCommand(cwdRef.current, commandLine, userRef.current);
          ...
          if (result.action === 'top_sim') {
             ...
             while (Date.now() - startTime < duration) {
                 ...
                 const processes = [
                    ...
                    ` 1337 ${userRef.current}     20   0   42.0m   2.1m   1.4m S   0.0   0.0  14:02.11 bash`,
          ...
          if (result.newUser) {
             userRef.current = result.newUser;
          }
        }
