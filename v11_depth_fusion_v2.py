...
if __name__ == "__main__":
    ...
    # Mount point for yolo-gcp bucket
    MOUNT_DATA = "/mnt/disks/data" 
    
    # Input List (V2)
    VIDEO_LIST_PATH = os.path.join(MOUNT_SHARE, "fp_videos_list_v2.txt")
    
    # Output Dir
    OUTPUT_BUCKET = os.environ.get("OUTPUT_BUCKET", os.path.join(MOUNT_SHARE, "output/v11_test_v2/"))
    ...
    with open(VIDEO_LIST_PATH, 'r') as f:
        for line in f:
            ...
            # Convert gs://yolo-gcp/ path to local mount path
            if line.startswith("gs://yolo-gcp/"):
                local_path = line.replace("gs://yolo-gcp/", MOUNT_DATA + "/")
