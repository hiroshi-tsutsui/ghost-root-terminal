...
| **v4_model_s** | phone | 52 | 27 | 16 | 10 | 7 | 7 | 3 | 2 |
| | **others** | 62 | 14 | 6 | 3 | 2 | 1 | 1 | 1 |
| | cigarette | 39 | 23 | 11 | 5 | 2 | 2 | 1 | 1 |
| **v5_model_s** | phone | 52 | 20 | 10 | 7 | 5 | 4 | 2 | 2 |
| | **others** | 62 | 12 | 5 | 3 | 0 | 0 | 0 | 0 |
| | cigarette | 39 | 22 | 9 | 3 | 2 | 2 | 1 | 1 |"""
print(history)

# V6 実データ
v6_p = extract_threshold_metrics("./build_tmp/v6_results/phone.json")
v6_o = extract_threshold_metrics("./build_tmp/v6_results/others.json")
v6_c = extract_threshold_metrics("./build_tmp/v6_results/cigarette.json")

if v6_p:
    print(f"| **v6_model_s** | phone | 52 | {' | '.join(map(str, v6_p))} |")
    print(f"| | **others** | 62 | {' | '.join(map(str, v6_o))} |")
    print(f"| | cigarette | 39 | {' | '.join(map(str, v6_c))} |")
